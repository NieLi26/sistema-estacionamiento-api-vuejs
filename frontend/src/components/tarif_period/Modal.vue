...
const handleSubmit = () => {
  ...
  if (!errors.value.length) {
    ...
    props.action === 'create' ? requestMethod = FarePeriodAPI.createFarePeriod(formData) : props.action === 'update' ? requestMethod = FarePeriodAPI.updateFarePeriod(props.fare.id, formData) : requestMethod = FarePeriodAPI.deleteFarePeriod(props.fare.id)
